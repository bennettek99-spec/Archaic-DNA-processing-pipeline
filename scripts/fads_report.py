...
Output: docs/studies/FADS_REPORT.md + reports/fads_report.html + figures fig_fads_*.
"""
...
def main():
    ...
    print("\nWrote docs/studies/FADS_REPORT.md + reports/fads_report.html")
...
def write_report(T, ST, it_slope, it_p, it_n, eu_slope, eu_p, eu_n, n_snp, figs):
    ...
    open(os.path.join(HERE, "docs", "studies", "FADS_REPORT.md"), "w", encoding="utf-8").write(md)
...
<footer>Method &amp; code: <code>fads_report.py</code>, <code>archaic/loci.py</code>. Companion: <code>docs/studies/FADS_REPORT.md</code>. Refs: Mathieson 2015; Ye 2017; Buckley 2017.</footer>
</div></body></html>"""
