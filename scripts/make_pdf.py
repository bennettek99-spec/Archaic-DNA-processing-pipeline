...
report's PAPER*.md can sit next to its own figures).
    ...
    python scripts/make_pdf.py <source.md> <out.pdf>
    python scripts/make_pdf.py                              # legacy default: docs/studies/PAPER.md -> reports/Etruscan_paper.pdf
...
def main():
    src = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "docs", "studies", "PAPER.md")
