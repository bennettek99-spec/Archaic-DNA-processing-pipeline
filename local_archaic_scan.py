...
claims (cf. FADS_REPORT.md).

Outputs:
  results/local_archaic_<panel>_windows.csv
  results/figures/fig_local_archaic_scan.png
  LOCAL_ARCHAIC_REPORT.md

Usage:
  python local_archaic_scan.py --panel 1240k
  python local_archaic_scan.py --panel 1240k --region WestEurasia --win 1000000
  python local_archaic_scan.py --panel 1240k --limit 500      # quick smoke test
"""
...
def validate_and_report(w, panel, cohort_name, n_ind, n_info, win, step):
    ...
    md = ["# Genome-wide local archaic-affinity scan\n",
          ...
          "(FADS_REPORT.md shows why an 'archaic' peak can be common ancestral variation).\n",
          ...
          "Genet. 16:359.*\n"]
    path = os.path.join(ROOT, "LOCAL_ARCHAIC_REPORT.md")
