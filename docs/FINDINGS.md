...
```
python scripts/phase1_validate.py                 # estimator validation (HO)
python scripts/phase2_prepare.py   --panel 1240k  # dataset + QC + exclusion log
python scripts/phase3_estimate.py  --panel 1240k  # per-genome archaic estimates (~27 min)
python scripts/phase4_normalize.py --panel 1240k  # bias diagnostics + analysis table
python scripts/phase5_pca.py       --panel 1240k  # ancestry PCA
python scripts/phase6_outliers.py  --panel 1240k  # expectation + standardized residuals
python scripts/phase7_reports.py   1240k          # per-candidate investigation reports
python scripts/phase8_figures.py   1240k          # publication figures
python scripts/phase9_robustness.py --panel 1240k # robustness / sensitivity
```
