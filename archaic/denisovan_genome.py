...
<section><h2>Reproducibility</h2><p>Command: <code>{html.escape(manifest['command'])}</code></p><p>Panel: <code>{html.escape(panel.prefix)}</code>. Generated {html.escape(generated)}. Machine-readable tables and the complete manifest sit beside this report.</p></section>
...
def run(panel_name: str, target: str, output: Path, config: str | None = None) -> dict:
    ...
    manifest = {
        ...
        "input_provenance": {
            ext: {
                "path": os.path.abspath(prefix + ext),
