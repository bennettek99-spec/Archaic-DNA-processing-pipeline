...
Outputs:
  ...
  docs/studies/DENISOVAN_REPORT.md

Usage:
  python scripts/denisovan_survey.py --panel 1240k
  python scripts/denisovan_survey.py --panel 1240k --min-snps 100000
"""
...
def write_report(df, hp, out, zstar, lon_r, epas, panel, min_snps):
    ...
    path = os.path.join(ROOT, "docs", "studies", "DENISOVAN_REPORT.md")
