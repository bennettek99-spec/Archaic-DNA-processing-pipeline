...
self-contained HTML report -> reports/etruscan_report.html (+ docs/studies/ETRUSCAN_FINDINGS.md).
...
def main():
    ...
    print("\nWrote results/etruscan/* , figures, reports/etruscan_report.html, docs/studies/ETRUSCAN_FINDINGS.md")
...
def write_reports(A, etr_out, C, o_absz, no_absz, strong, explained, slope, p_time,
    ...
    open(os.path.join(HERE, "docs", "studies", "ETRUSCAN_FINDINGS.md"), "w", encoding="utf-8").write("\n".join(md) + "\n")
...
<footer>Generated by <code>etruscan_study.py</code>. Companion: <code>docs/studies/ETRUSCAN_FINDINGS.md</code>. Method &amp; citations: <code>README.md</code>.</footer>
</div></body></html>"""
