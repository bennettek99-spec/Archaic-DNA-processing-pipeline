...
Outputs:
  ...
  docs/studies/XCHROM_REPORT.md

Usage:
  python scripts/xchrom_depletion.py                 # panel ho (the one that works)
  python scripts/xchrom_depletion.py --limit 500     # quick smoke test
"""
...
def write_report(df, panel, n_auto, n_x):
    ...
    path = os.path.join(ROOT, "docs", "studies", "XCHROM_REPORT.md")
