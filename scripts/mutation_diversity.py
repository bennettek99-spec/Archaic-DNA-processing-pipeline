...
Output: docs/studies/DIVERSITY_REPORT.md + reports/diversity_report.html + figures.
"""
...
def main():
    ...
    print("\nWrote docs/studies/DIVERSITY_REPORT.md + reports/diversity_report.html")
...
def write_report(D, top, bot, sl, r, p, figs, cmp, top_ho):
    ...
    md = DIV_MD.format(
        ...
        n_overlap=len(cmp))
    open(os.path.join(HERE, "docs", "studies", "DIVERSITY_REPORT.md"), "w", encoding="utf-8").write(md)
...
<footer>Method &amp; code: <code>mutation_diversity.py</code>. Companion: <code>docs/studies/DIVERSITY_REPORT.md</code>. Refs: Ramachandran 2005; Henn 2012; Mallick 2016 (SGDP); Harris 2015.</footer>
</div></body></html>"""
