...
def main():
    ...
    md += ["", "## Key tests", "```", *K, "```", "",
           "![validation](../../results/figures/fig7_validation_vs_published.png)", "",
           "![bland-altman](../../results/figures/fig8_validation_bland_altman.png)", "",
    ...
    with open(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "docs", "studies", "VALIDATION.md"),
